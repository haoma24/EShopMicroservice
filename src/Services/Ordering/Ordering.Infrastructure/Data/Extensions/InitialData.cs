...
internal static class InitialData
{
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            var address1 = Address.Of("mehmet", "ozkaya", "mehmetozkaya@gmail.com", "Adress1", "Country1", "State1", "ZipCode1");
            var address2 = Address.Of("john", "doe", "johndoe@gmail.com", "Adress2", "Country2", "State2", "ZipCode2");

            var payment1 = Payment.Of("mehmet", "5555555555554444", "12/28", "355", 1);
            var payment2 = Payment.Of("john", "8885555555554444", "06/30", "222", 2);

            var order1 = Order.Create(
                OrderId.Of(new Guid("3f24b20b-77b0-411c-b05d-04f4cd3a2d65")),
                CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")),
                OrderName.Of("ORD_1"),
                address1,
                address1,
            ...
            var order2 = Order.Create(
                OrderId.Of(new Guid("fc4b9b8f-7c9f-47c0-b5e1-dc2a62d31de5")),
                CustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")),
                OrderName.Of("ORD_2"),
                address2,
                address2,
